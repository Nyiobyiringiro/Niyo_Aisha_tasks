    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
              <a  class="nav-link" href="../layout/index.php">Index</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../layout/controlflow.php">Control flow</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="../layout/array.php">Arrays</a>
            </li>
            <li class="nav-item">
